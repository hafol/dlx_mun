...
import { Users, Star, Send, CheckCircle, Loader2, Search, Filter, Trophy, MessageSquare, Globe } from 'lucide-react';
...
export default function ChairDashboard() {
  ...
  if (myConferences.length === 0) {
    return (
      <main className="pt-24 pb-20 px-6 flex items-center justify-center min-h-[80vh]">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl font-black tracking-tighter mb-4 uppercase">No Assignments</h1>
          <p className="text-on-surface/60 mb-8 leading-relaxed">
            You are not currently assigned as a Chair to any active MUN conferences. Apply for a Chair position on the Conferences page.
          </p>
          <Link to="/conferences">
      ...
      <main className="pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <header className="mb-12">
            <h1 className="text-4xl font-black tracking-tighter mb-4 uppercase">Select <span className="text-primary-container">Conference</span></h1>
            <p className="text-on-surface/60">Choose the conference you want to manage and evaluate delegates for.</p>
          </header>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <button 
                ...
                className="p-2 hover:bg-white/5 rounded-lg text-on-surface/40 hover:text-on-surface transition-colors"
              >
                <Filter size={16} />
              </button>
              ...
              <span className="text-[10px] uppercase tracking-widest font-bold text-primary-container">{selectedConf.title}</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tight mb-4 uppercase">Delegate <span className="text-primary-container">Evaluation</span></h1>
          </div>
          <button 
            onClick={() => setSelectedConf(null)}
            className="text-[10px] font-bold uppercase tracking-widest text-on-surface/40 hover:text-primary-container transition-colors"
          >
            Switch Conference
          </button>
        </header>
